...
public class EmployeeController {
	...
	@GetMapping("/employees/salary/{lpr}/{hpr}")
	public ModelAndView getEmployeeBySalary(@PathVariable int lpr,@PathVariable int hpr) {
		List<Employee> elist=eservice.getBySalary(lpr,hpr);
		return new ModelAndView("displayemployee","elist",elist);				
	}
